...
def _get_keys(USER_NAME, USER_PRK):
	...
	USER_AES = encrypt.decrypt_aes(USER_PRK, cipheraes[0])
...
def rm_r(USER_NAME, USER_PATH, USER_PRK, args):
	...
	for parent,dirnames,filenames in os.walk(rm_path):
		for filename in filenames:
			rm(USER_NAME, USER_PATH, USER_PRK, [os.path.join(parent,filename)])
...
def mv(USER_NAME, USER_PATH, USER_PRK, args):
...
if __name__ == '__main__':
	...
	#upload('hey', 'hey', '/Users/mac/Desktop/system_security/pj/Encryped-file-system/src/hey.pem', ['/Users/mac/Desktop/1.png', 'dic1'])
